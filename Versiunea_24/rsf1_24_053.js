(function ($) {
    ...
    function validate_57_005_57_010() {
        ...
        var idnoCuiioList = [
            { IDNO: 1007607008364, CUIIO: 40476416, start: "01.03.2024", end: "28.02.2025" },
            { IDNO: 1002600008706, CUIIO: 399159, start: "01.03.2024", end: "28.02.2025" },
            { IDNO: 1016600004811, CUIIO: 41101919, start: "01.03.2024", end: "28.02.2025" },
            { IDNO: 1015600041312, CUIIO: 41086545, start: "01.04.2024", end: "31.03.2025" },
            { IDNO: 1016600017134, CUIIO: 41126823, start: "01.04.2024", end: "31.03.2025" },
            { IDNO: 1022600006450, CUIIO: 41537083, start: "01.04.2024", end: "31.03.2025" },
            { IDNO: 1019600000157, CUIIO: 41306455, start: "01.04.2024", end: "31.03.2025" },
            { IDNO: 1016600007074, CUIIO: 41108494, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1002600052466, CUIIO: 9774281, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1003611004932, CUIIO: 40006656, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1017600019696, CUIIO: 41171185, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1015604000814, CUIIO: 41040514, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1014604002143, CUIIO: 40995978, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1003604011987, CUIIO: 966406, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1003611004943, CUIIO: 37398380, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1020604000843, CUIIO: 41406317, start: "01.07.2023", end: "30.06.2024" },
            { IDNO: 1003600000730, CUIIO: 3941230, start: "01.01.2024", end: "30.06.2024" },
            { IDNO: 1011604000182, CUIIO: 40737437, start: "01.10.2023", end: "30.09.2024" },
            { IDNO: 1004601002738, CUIIO: 40141561, start: "01.10.2023", end: "30.09.2024" },
        ...
        var match = idnoCuiioList.find(entry => entry.IDNO === IDNO && entry.CUIIO === CUIIO);

        if (match) {
            var allowedStartDate = new Date(match.start.split(".")[2], match.start.split(".")[1] - 1, match.start.split(".")[0]);
            var allowedEndDate = new Date(match.end.split(".")[2], match.end.split(".")[1] - 1, match.end.split(".")[0]);
    ...
    webform.validators.validate_rsf1_1 = function () {
        ...
        var annex3Errors = validateAnnex3Completion(values);
...
//-------------------------------------------------------------------------------
        ...
        var annexErrors = validateAnnexes(values);

        // Push errors into webform.errors
        annexErrors.forEach(function (error) {
            webform.errors.push({
                'fieldName': error.fieldName,
                'index': 0,
                'weight': 10,
...
// -------------------------------------------------------------------------------------
      ...
      //  validate_57_005_57_010();   
        ...
        var idnoCuiioList = [
            ...
            { IDNO:  1007607008364, CUIIO: 40476416 }, // 01.03.2024-28.02.2025
            { IDNO:  1002600008706, CUIIO: 399159 }, // 01.03.2024-28.02.2025
            { IDNO:  1016600004811, CUIIO: 41101919 }, // 01.03.2024-28.02.2025
            { IDNO:  1015600041312, CUIIO: 41086545 }, // 01.04.2024-31.03.2025 // 
            { IDNO:  1016600017134, CUIIO: 41126823 }, // 01.04.2024-31.03.2025
            { IDNO:  1022600006450, CUIIO: 41537083 }, // 01.04.2024-31.03.2025
            { IDNO:  1019600000157, CUIIO: 41306455 }, // 01.04.2024-31.03.2025
            { IDNO:  1016600007074, CUIIO: 41108494 }, // 01.07.2023-30.06.2024
            { IDNO:  1002600052466, CUIIO: 9774281 }, // 01.07.2023-30.06.2024
            { IDNO:  1003611004932, CUIIO: 40006656 },  //01.07.2023-30.06.2024
            { IDNO:  1017600019696, CUIIO: 41171185 }, // 01.07.2023-30.06.2024
            { IDNO:  1015604000814, CUIIO: 41040514 }, // 01.07.2023-30.06.2024
            { IDNO:  1014604002143, CUIIO: 40995978 }, // 01.07.2023-30.06.2024
            { IDNO:  1003604011987, CUIIO: 966406 }, // 01.07.2023-30.06.2024
            { IDNO:  1003611004943, CUIIO: 37398380 }, // 01.07.2023-30.06.2024
            { IDNO:  1020604000843, CUIIO: 41406317 }, // 01.07.2023-30.06.2024 
            { IDNO:  1003600000730, CUIIO: 3941230 }, // 01.01.2024-30.06.2024 
            { IDNO:  1011604000182, CUIIO: 40737437 }, // 01.10.2023-30.09.2024
            { IDNO:  1004601002738, CUIIO: 40141561 }, // 01.10.2023-30.09.2024
            { IDNO:  1014600032562, CUIIO: 41011151 }, // 01.01.2024-30.09.2024 
        ];
        ...
        } else if ((endPeriod.length == 3 && startPeriod.length == 3) && !match) {
...
// 
    ...
    //Modify this Modify this function Define a regular expression to allow only letters, numbers, spaces, and basic punctuation - And all the letters of the Romanian and Russian alphabets
//----------------------------------------------------------------------
    function validateFieldNoHieroglyphs(fieldName, fieldValue) {
        // Define a regular expression to allow only letters, numbers, spaces, and basic punctuation - And all the letters of the Romanian and Russian alphabets
...
//---------------------------------------------------------------------------
    function validateAnnexes(values) {
        ...
        // Helper function to safely parse integers with fallback to 0
        ...
        //Daca (rind 190 (COL4 sau  COL5 sau COL6 sau COL7)  <> 0 si annex1Row410Col5 > 0)
        //si (annex4Row080Col4 =  0 si annex4Row240Col3 = 0 si annex4Row240Col4 = 0) 
        //atunci trebuie sa fie Anexa 4 
        return errors;
    }

//------------------------------------------------------------------------

    function validateAnnex3Completion(values) {
        var errors = [];
        ...
        var annex4Row240Col4 = safeParseInt(values.dec_table4_row_r240c4);
        var annex1Row620Col5 = safeParseInt(values.dec_table1_row_r620c5);

        // Check if all columns in row 190 are empty in Anexa 3
        var annex3Row190Col4 = safeParseInt(values.dec_table3_row_r190c4);
        var annex3Row190Col5 = safeParseInt(values.dec_table3_row_r190c5);
        var annex3Row190Col6 = safeParseInt(values.dec_table3_row_r190c6);
        var annex3Row190Col7 = safeParseInt(values.dec_table3_row_r190c7);

        var annex3Row190AllEmpty = annex3Row190Col4 === 0 &&
            annex3Row190Col5 === 0 &&
            annex3Row190Col6 === 0 &&
            annex3Row190Col7 === 0;
    ...
    //  (annex4Row080Col4 !== 0 sau  (annex4Row240Col3 !== 0 && annex4Row240Col4 !== 0 && annex1Row620Col5 !== 0) ) si annex3Row190ColsEmpty ) sa afiseze eroare Trebuie sa fie anexa 3 
//------------------------------------------------------------------------
